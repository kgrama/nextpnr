...
{
    return cell_type.in(id_ODDR, id_ODDRC, id_OSER4, id_OSER4_MEM, id_OSER8, id_OSER8_MEM, id_OSER10, id_OVIDEO, id_IOLOGICO_EMPTY);
}
...
{
    return cell_type.in(id_IDDR, id_IDDRC, id_IDES4, id_IDES4_MEM, id_IDES8, id_IDES8_MEM, id_IDES10, id_IVIDEO, id_IOLOGICI_EMPTY);
}
